package com.example.mycontact.ui.components
...
private fun LightDarkThemeItem() {
    Row(
        ...
        Switch(
            checked = MyContactThemeSettings.isDarkThemeEnabled,
            onCheckedChange = { MyContactThemeSettings.isDarkThemeEnabled = it },
            modifier = Modifier
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            isSelected = currentScreen == Screen.Contacts,
            onClick = {
                PhoneNumberRouter.navigateTo(Screen.Closefriend)
                closeDrawerAction()
            }
        )
        ScreenNavigationButton(
