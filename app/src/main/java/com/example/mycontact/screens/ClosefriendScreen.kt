...
import com.example.mycontact.ui.components.AppDrawer
import com.example.mycontact.ui.components.Contact
import com.example.mycontact.viewmodel.MainViewModel
import kotlinx.coroutines.launch

@ExperimentalMaterialApi
@Composable
fun ClosefriendScreen(viewModel: MainViewModel) {
...
@ExperimentalMaterialApi
@Composable
private fun ClosefriendList(
    contacts: List<ContactModel>,
    onContactCheckedChange: (ContactModel) -> Unit,
    onContactClick: (ContactModel) -> Unit
) {
    val close = contacts.filter{ it.isColsefriend}
    LazyColumn {
        items(count = close.size) { noteIndex ->
            val contact = close[noteIndex]
            Contact(
                contact = contact,
...
@Preview
@Composable
private fun ClosefriendListPreview() {
    ClosefriendList(
        contacts = listOf(
