package com.example.mycontact.screens
...
import com.example.mycontact.domain.model.ContactModel
import com.example.mycontact.domain.model.TagModel
import com.example.mycontact.routing.PhoneNumberRouter

import com.example.mycontact.domain.model.NEW_CONTACT_ID

import com.example.mycontact.routing.Screen
import com.example.mycontact.ui.components.ContactColor
import com.example.mycontact.util.fromHex
    ...
    TopAppBar(
        ...
        actions = {
            ...
            IconButton(onClick = onOpenTagPickerClick) {
                Icon(
                    painter = painterResource(id = R.drawable.tagman),
...
private fun SaveContactContent(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        val isChecked: Boolean = contact.isColsefriend
        ...
        FavoriteCheckOption(
            ...
            onCheckedChange = { FavoriteNewValue ->
                ...
                onContactChange.invoke(contact.copy(isColsefriend = isCheckedOff))
            }
        )
        ContentTextField(
            label = "Name",
